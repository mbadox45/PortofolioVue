...
export const listIcon = [
    {id:1, name:'Github', icon:'pi-github', routes:'/resume'},
    {id:2, name:'LinkedIn', icon:'pi-linkedin', routes:'/project'},
    {id:3, name:'Instagram', icon:'pi-instagram', routes:'/contact'},
];
export const listBottomEnglish = [
    {id:1, name:'5', ket:'Years experience'},
    {id:2, name:'10', ket:'Project completed'},
    {id:3, name:'12', ket:'Technologies mastered'},
];
export const listBottomIndo = [
    {id:1, name:'5', ket:'Tahun pengalaman'},
    {id:2, name:'10', ket:'Projek selesai'},
    {id:3, name:'12', ket:'Teknologi dikuasai'},
];
