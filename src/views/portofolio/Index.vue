...
<template>
    <div class="relative w-full min-h-screen bg-gray-900">
    <!-- <div class="w-full min-h-screen bg-gradient-to-r from-gray-900 via-gray-900 to-gray-500"> -->
        <!-- <Particles /> -->
        <nav class="fixed z-50 flex justify-between w-full font-sans bg-gray-900">
            <div class="px-[100px] py-3 rounded-tr-full w-full">
                <img src="/rta.png" alt="Mbadox45" class="p-1 bg-gray-100 rounded-full border-gray-50" width="50px">
        ...
        <div class="flex flex-col sm:flex-row w-full px-[2rem] min-h-screen">
            <router-view />
        </div>
    </div>
</template>